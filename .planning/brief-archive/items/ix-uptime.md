...
No external uptime monitor has ever been picked (UptimeRobot vs BetterStack). /api/health is live and returns {status, db, timestamp}, so this is a wiring job, not a build. Phase 4 left it open
