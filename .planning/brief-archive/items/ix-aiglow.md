...
The lesson-cleared card is loved, BUT the outer glow and contour box read as generic AI styling. Find a way to give it depth without that look. Same principle applies anywhere else the glow pattern is used
