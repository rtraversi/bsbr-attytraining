...
FAQ and support page contain AI filler rather than real answers. Rewrite with actual content. Same rule as the em-dash note: if it reads like placeholder, delete it
