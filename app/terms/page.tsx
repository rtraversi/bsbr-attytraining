...
export const metadata = {
  title: 'Terms of Service — IURIX',
}

export default function TermsPage() {
  return (
    <LegalPage title="Terms of Service" updated="Last updated: [DATE] — [ATTORNEY TO COMPLETE]">
      ...
      <LegalSection title="4. Refund Policy">
        <p>
          Refunds are available within 14 days of purchase <strong className="font-semibold text-white/80">and</strong> only
      ...
      <LegalSection title="9. Contact">
        ...
        <p>
          Current contact:{' '}
          <LegalLink href="mailto:info@aistaffcompliance.com">
