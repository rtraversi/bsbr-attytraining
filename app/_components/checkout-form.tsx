    ...
    <form onSubmit={handleSubmit} className="flex flex-col items-center gap-4">
      <div className="flex items-center gap-4">
        ...
        <input
          ...
          className="bg-gray-100 rounded-lg px-3 py-2 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <input
          ...
          className="w-24 bg-gray-100 rounded-lg px-3 py-2 text-center text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      <label className="flex max-w-sm cursor-pointer items-start gap-2.5 text-sm text-gray-600">
        ...
        <span>
          ...
          , and I am authorized to accept them for my firm.
        </span>
      </label>
