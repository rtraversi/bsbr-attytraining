      ...
      <main>
        ...
        <section id="pricing" className="bg-white py-24 px-6 md:px-[80px]">
          <div className="max-w-[480px] mx-auto text-center">
            <h2 className="font-host-grotesk text-3xl font-bold text-[#1b1c1c] mb-2">
              Get your team certified
            </h2>
            <p className="font-host-grotesk text-base text-[#544439] mb-10">
              One annual fee. All staff certified. Certificates ready in under an hour.
            </p>
            <CheckoutForm />
            <p className="mt-4 text-xs text-gray-400 leading-relaxed">
              Refunds available within 14 days of purchase and only if no certificate has yet been
