...
export function DashboardShell({
  ...
  return (
    <div className="font-headline flex min-h-screen flex-col bg-[#CFDCE8] text-[#0A0A0A] transition-colors dark:bg-[#050607] dark:text-[#F5F7FA]">
      <div className="px-4 py-3 md:px-6">{pill}</div>
      <ToastProvider>
        <div className="mx-auto w-full max-w-[1600px] px-6 py-6 md:px-10 md:py-8 xl:px-14 xl:py-14">
          {children}
        </div>
      </ToastProvider>
    </div>
