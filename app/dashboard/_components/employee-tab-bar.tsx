...
export function EmployeeTabBar() {
  ...
  return (
    <nav
      ...
      className="font-headline fixed inset-x-0 bottom-0 z-40 bg-white/95 shadow-[0_-6px_24px_rgba(0,148,255,0.08)] backdrop-blur dark:bg-[#0D0F12]/95 dark:shadow-[0_-6px_24px_rgba(0,0,0,0.5)]"
    >
